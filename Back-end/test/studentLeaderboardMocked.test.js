...
describe("test student leaderboard", () => {
  ...
  test("get leaderboard with student highest ", async (done) => {
    let response = await request.get("/").query({ classCode: "1", userId: "1", isInstructor: "false"});
  ...
  test("get leaderboard with student lowest (out of 10) ", async (done) => {
    let response = await request.get("/").query({ classCode: "1", userId: "11", isInstructor: "false"});
  ...
  test("get leaderboard with student somewhere in between ", async (done) => {
    let response = await request.get("/").query({ classCode: "1", userId: "5", isInstructor: "false"});
  ...
  test("get student leaderboard as a teacher", async (done) => {
    let response = await request.get("/").query({ classCode: "1", userId: "5", isInstructor: "true"});
