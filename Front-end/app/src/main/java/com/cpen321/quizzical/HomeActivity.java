...
public class HomeActivity extends AppCompatActivity {
    ...
    private void classCodeSet(int code) {
        //we need to check that the code is valid on the server
        //use POST request with content: username=xxx;class_code=xxx
        sp.edit().putInt(getString(R.string.class_code), code).apply();
    }

    private void courseCategorySet(int category) {
        //this value should be generated by the server and sent to user's email as well.
        //we should first send a POST request to the server
